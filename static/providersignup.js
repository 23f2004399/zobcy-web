...
signupForm.addEventListener('submit', (e) => {
    ...
    createUserWithEmailAndPassword(auth, email, password)
        .then((userCredential) => {
            ...
            // Now, we save the user's extra details to the Firestore database.
            // We will create a collection called "providers" to store all provider data.
        ...
        .then(() => {
            ...
            // Wait 2 seconds, then redirect the user to the provider login page
            setTimeout(() => {
                window.location.href = '/providerlogin?signup=success';
